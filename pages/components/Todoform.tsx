    ...
    return(
        ...
        <section>
            <header >
                ...
                />
                <button id="input-form-btn"><i className="fa-solid fa fa-plus"></i></button>
                </form>
            </header>
            ...
            <div className="container">
                ...
                <div className="btn">
                <button id="del" onClick={()=>deletetodo(index)}><i className="fa-solid fa-trash-can fa fa-trash-o"></i></button>
                </div>
                </div>
                    </>
                ))}
